...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  5 13:26:08 2017
...
path = '/Users/JayBaek/Desktop/running1.csv'
path1 = '/Users/JayBaek/Desktop/walking.csv'
def createDataSet(path, path1):
    ...
    for i in range (len(x1)):
        dataSet.append([x[i], 'yes'])
    for i in range (len(x1)):
        dataSet.append([x1[i], 'no'])
              #0 jogging data, yes
    labels = ['running']
    # change to discrete values
    return dataSet, labels
    
dataSet, labels = createDataSet(path, path1)
...
answer = classify(mytree, ['running'], [13])
print("Hi, the answer is "+ answer + ", it is running data")
